...
const QString BITCOIN_IPC_PREFIX("twecoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click twecoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start twecoin: click-to-pay handler");
    else
...
{
    // clicking on twecoin: URLs creates FileOpen events on the Mac:
